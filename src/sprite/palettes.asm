...
incbin "data/palette_ship_glow.bin":(3*2)-(4*2)   -> $8DCA4E+6+(3*6)
incbin "data/palette_ship_glow.bin":(4*2)-(5*2)   -> $8DCA4E+6+(4*6)
incbin "data/palette_ship_glow.bin":(5*2)-(6*2)   -> $8DCA4E+6+(5*6)
incbin "data/palette_ship_glow.bin":(6*2)-(7*2)   -> $8DCA4E+6+(6*6)
incbin "data/palette_ship_glow.bin":(7*2)-(8*2)   -> $8DCA4E+6+(7*6)
incbin "data/palette_ship_glow.bin":(8*2)-(9*2)   -> $8DCA4E+6+(8*6)
incbin "data/palette_ship_glow.bin":(9*2)-(10*2)  -> $8DCA4E+6+(9*6)
incbin "data/palette_ship_glow.bin":(10*2)-(11*2) -> $8DCA4E+6+(10*6)
incbin "data/palette_ship_glow.bin":(11*2)-(12*2) -> $8DCA4E+6+(11*6)
...
incbin "data/palette_ship_outro.bin":(3*30)-(4*30)   -> $8DD6BA+2+6+(3*$24)
incbin "data/palette_ship_outro.bin":(4*30)-(5*30)   -> $8DD6BA+2+6+(4*$24)
incbin "data/palette_ship_outro.bin":(5*30)-(6*30)   -> $8DD6BA+2+6+(5*$24)
incbin "data/palette_ship_outro.bin":(6*30)-(7*30)   -> $8DD6BA+2+6+(6*$24)
incbin "data/palette_ship_outro.bin":(7*30)-(8*30)   -> $8DD6BA+2+6+(7*$24)
incbin "data/palette_ship_outro.bin":(8*30)-(9*30)   -> $8DD6BA+2+6+(8*$24)
incbin "data/palette_ship_outro.bin":(9*30)-(10*30)  -> $8DD6BA+2+6+(9*$24)
incbin "data/palette_ship_outro.bin":(10*30)-(11*30) -> $8DD6BA+2+6+(10*$24)
incbin "data/palette_ship_outro.bin":(11*30)-(12*30) -> $8DD6BA+2+6+(11*$24)
incbin "data/palette_ship_outro.bin":(12*30)-(13*30) -> $8DD6BA+2+6+(12*$24)
incbin "data/palette_ship_outro.bin":(13*30)-(14*30) -> $8DD6BA+2+6+(13*$24)
...
incbin "data/palette_power_loader.bin":(3*30)-(4*30) -> $8DDB62+2+$07C
incbin "data/palette_power_loader.bin":(4*30)-(5*30) -> $8DDB62+2+$0A7
incbin "data/palette_power_loader.bin":(5*30)-(6*30) -> $8DDB62+2+$0CB
incbin "data/palette_power_loader.bin":(6*30)-(7*30) -> $8DDB62+2+$0F6
...
incbin "data/palette_varia_loader.bin":(3*30)-(4*30) -> $8DDCC8+2+$07C
incbin "data/palette_varia_loader.bin":(4*30)-(5*30) -> $8DDCC8+2+$0A7
incbin "data/palette_varia_loader.bin":(5*30)-(6*30) -> $8DDCC8+2+$0CB
incbin "data/palette_varia_loader.bin":(6*30)-(7*30) -> $8DDCC8+2+$0F6
...
incbin "data/palette_gravity_loader.bin":(3*30)-(4*30) -> $8DDE2E+2+$07C
incbin "data/palette_gravity_loader.bin":(4*30)-(5*30) -> $8DDE2E+2+$0A7
incbin "data/palette_gravity_loader.bin":(5*30)-(6*30) -> $8DDE2E+2+$0CB
incbin "data/palette_gravity_loader.bin":(6*30)-(7*30) -> $8DDE2E+2+$0F6
...
incbin "data/palette_power_heat.bin":(3*30)-(4*30)   -> $8DE45E+$A+(3*$22)
incbin "data/palette_power_heat.bin":(4*30)-(5*30)   -> $8DE45E+$A+(4*$22)
incbin "data/palette_power_heat.bin":(5*30)-(6*30)   -> $8DE45E+$A+(5*$22)
incbin "data/palette_power_heat.bin":(6*30)-(7*30)   -> $8DE45E+$A+(6*$22)
incbin "data/palette_power_heat.bin":(7*30)-(8*30)   -> $8DE45E+$A+(7*$22)
incbin "data/palette_power_heat.bin":(8*30)-(9*30)   -> $8DE45E+$A+(8*$22)
incbin "data/palette_power_heat.bin":(9*30)-(10*30)  -> $8DE45E+$A+(9*$22)
incbin "data/palette_power_heat.bin":(10*30)-(11*30) -> $8DE45E+$A+(10*$22)
incbin "data/palette_power_heat.bin":(11*30)-(12*30) -> $8DE45E+$A+(11*$22)
incbin "data/palette_power_heat.bin":(12*30)-(13*30) -> $8DE45E+$A+(12*$22)
incbin "data/palette_power_heat.bin":(13*30)-(14*30) -> $8DE45E+$A+(13*$22)
...
incbin "data/palette_varia_heat.bin":(3*30)-(4*30)   -> $8DE68A+$A+(3*$22)
incbin "data/palette_varia_heat.bin":(4*30)-(5*30)   -> $8DE68A+$A+(4*$22)
incbin "data/palette_varia_heat.bin":(5*30)-(6*30)   -> $8DE68A+$A+(5*$22)
incbin "data/palette_varia_heat.bin":(6*30)-(7*30)   -> $8DE68A+$A+(6*$22)
incbin "data/palette_varia_heat.bin":(7*30)-(8*30)   -> $8DE68A+$A+(7*$22)
incbin "data/palette_varia_heat.bin":(8*30)-(9*30)   -> $8DE68A+$A+(8*$22)
incbin "data/palette_varia_heat.bin":(9*30)-(10*30)  -> $8DE68A+$A+(9*$22)
incbin "data/palette_varia_heat.bin":(10*30)-(11*30) -> $8DE68A+$A+(10*$22)
incbin "data/palette_varia_heat.bin":(11*30)-(12*30) -> $8DE68A+$A+(11*$22)
incbin "data/palette_varia_heat.bin":(12*30)-(13*30) -> $8DE68A+$A+(12*$22)
incbin "data/palette_varia_heat.bin":(13*30)-(14*30) -> $8DE68A+$A+(13*$22)
...
incbin "data/palette_gravity_heat.bin":(3*30)-(4*30)   -> $8DE8B6+$A+(3*$22)
incbin "data/palette_gravity_heat.bin":(4*30)-(5*30)   -> $8DE8B6+$A+(4*$22)
incbin "data/palette_gravity_heat.bin":(5*30)-(6*30)   -> $8DE8B6+$A+(5*$22)
incbin "data/palette_gravity_heat.bin":(6*30)-(7*30)   -> $8DE8B6+$A+(6*$22)
incbin "data/palette_gravity_heat.bin":(7*30)-(8*30)   -> $8DE8B6+$A+(7*$22)
incbin "data/palette_gravity_heat.bin":(8*30)-(9*30)   -> $8DE8B6+$A+(8*$22)
incbin "data/palette_gravity_heat.bin":(9*30)-(10*30)  -> $8DE8B6+$A+(9*$22)
incbin "data/palette_gravity_heat.bin":(10*30)-(11*30) -> $8DE8B6+$A+(10*$22)
incbin "data/palette_gravity_heat.bin":(11*30)-(12*30) -> $8DE8B6+$A+(11*$22)
incbin "data/palette_gravity_heat.bin":(12*30)-(13*30) -> $8DE8B6+$A+(12*$22)
incbin "data/palette_gravity_heat.bin":(13*30)-(14*30) -> $8DE8B6+$A+(13*$22)
...
incbin "data/palette_power_charge.bin":(3*30)-(4*30) -> $9B9820+2+(3*$20)
incbin "data/palette_power_charge.bin":(4*30)-(5*30) -> $9B9820+2+(4*$20)
incbin "data/palette_power_charge.bin":(5*30)-(6*30) -> $9B9820+2+(5*$20)
...
incbin "data/palette_varia_charge.bin":(3*30)-(4*30) -> $9B9920+2+(3*$20)
incbin "data/palette_varia_charge.bin":(4*30)-(5*30) -> $9B9920+2+(4*$20)
incbin "data/palette_varia_charge.bin":(5*30)-(6*30) -> $9B9920+2+(5*$20)
...
incbin "data/palette_gravity_charge.bin":(3*30)-(4*30) -> $9B9A20+2+(3*$20)
incbin "data/palette_gravity_charge.bin":(4*30)-(5*30) -> $9B9A20+2+(4*$20)
incbin "data/palette_gravity_charge.bin":(5*30)-(6*30) -> $9B9A20+2+(5*$20)
...
incbin "data/palette_death.bin":(3*30)-(4*30) -> $9BA120+2+(3*$20)
incbin "data/palette_death.bin":(4*30)-(5*30) -> $9BA120+2+(4*$20)
incbin "data/palette_death.bin":(5*30)-(6*30) -> $9BA120+2+(5*$20)
incbin "data/palette_death.bin":(6*30)-(7*30) -> $9BA120+2+(6*$20)
...
incbin "data/palette_hyper.bin":(3*30)-(4*30) -> $9BA240+2+(3*$20)
incbin "data/palette_hyper.bin":(4*30)-(5*30) -> $9BA240+2+(4*$20)
incbin "data/palette_hyper.bin":(5*30)-(6*30) -> $9BA240+2+(5*$20)
incbin "data/palette_hyper.bin":(6*30)-(7*30) -> $9BA240+2+(6*$20)
incbin "data/palette_hyper.bin":(7*30)-(8*30) -> $9BA240+2+(7*$20)
